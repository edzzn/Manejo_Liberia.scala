...
/**
  ...
  */
class Reserva (val id: String, var estudiante : Estudiante, var libro : Libro, var fechaAReservar : Int, var fechaReserva : Int, var horaReserva : Int) extends Serializable{
